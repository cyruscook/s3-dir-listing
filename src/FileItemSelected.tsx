export default function FileItem(props: { objects: string[], selected: Set<string>, bucket: string, setSelected: (selected: Set<string>) => void, open: () => void, downloading: boolean, download: () => void, delete: () => void, readonly: boolean }) {
	...
	return (
		<>
            ...
            {props.readonly ? <></> : <td><button className="filebtn deletebtn" disabled={props.selected.size <= 0} onClick={props.delete}>&#10060;</button></td>}
		</>
	);
}